	...
	implements Micropolis.Listener, EarthquakeListener
{
	...
	public MainWindow(Micropolis engine)
	{
		...
		overlaysMenu.add(makeMapStateMenuItem("menu.overlays.HUNTER_OVERLAY", MapState.HUNTER_OVERLAY));
	...
	private void makeMenu()
	{
		...
		menuItem = new JMenuItem(strings.getString("menu.disasters.ZOMBIE"));
		setupKeys(menuItem, "menu.disasters.ZOMBIE");
		menuItem.addActionListener(wrapActionListener(
			new ActionListener() {
			public void actionPerformed(ActionEvent ev)
			{
				onInvokeDisasterClicked(Disaster.ZOMBIE);
			}
			}));
		disastersMenu.add(menuItem);
	...
	private JToolBar makeToolbar()
	{
		...
		b7.add(makeToolBtn(MicropolisTool.HUNTER));
